...
@implementation PeeQualityPickerSource
@synthesize item;
-(id)init
{
    self = [super init];
    if (self) {
        NSArray *viewArray = [[NSArray alloc]initWithObjects:@"",@"",@"",@"a few drops",@"medium amount",@"large amount", nil];
